...
The user approved building the structure first; substantive case-study and government content will follow. All pages are review drafts with noindex. Existing approved homepage design is preserved on main at bb3053f.

| Area | Ready for review | Needed before launch |
|---|---|---|
| Home | Approved visual direction, hero, navigation | Small copy edits and final image approval |
| Expertise | Six capability sections and approach | Confirm service wording |
| Case Studies | Listing layout and three approved organization names | Role, employment/engagement attribution, challenge, approach, deliverables, approved visuals, substantiated outcomes; then build three detail pages |
| Products | Catalyst feature; Open Air and WYWH sections | Confirm descriptions, availability and product destinations |
...
## Case-study content outline (repeat for each organization)
1. One-sentence challenge and appropriate attribution of the work.
2. Context: what was happening and who needed help.
3. Our role: precisely what Ether or its leadership/team delivered.
4. Approach: the key decisions and activities.
5. Outcome: support every number and claim with approved evidence.
6. Images: supplied/approved assets with clear reuse rights.
